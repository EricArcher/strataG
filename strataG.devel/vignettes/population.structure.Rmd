---
title: "Running Tests of Population Structure"
author: "Eric Archer"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Running Tests of Population Structure}
...
By default, stratification is taken from the _@strata_ slot of the object. Alternative stratification can be provided as a vector when the function is called:
```{r}
...
The result of a pairwise test contains both a data.frame formatted for each pairwise comparison and pairwise matrices for each statistic with p-values in the lower left and statistic estimates in the upper right.
```{r}
pws
```
