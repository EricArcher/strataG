...
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{fastsimcoal2}
...
Here's one replicate of a simulation with this matrix. The sample sizes have been increased to 30 per deme so we can better run some tests later.
