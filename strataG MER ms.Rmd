...
For each locus, there should be a column for each allele. Each column name should contain the locus name and a suffix that designates the allele. For example, the two columns of a diploid locus named "ABC" would be named "ABC.1" and "ABC.2". If all alleles are in a single column, the _alleleSplit_ function will create a matrix with them split into multiple columns.

The standard _new_ function 
